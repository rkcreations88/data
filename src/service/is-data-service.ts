...
/**
 * Checks if a service is a valid data service.
 * A data service may only contain the following types of properties:
 * - Observe<Data>
 ...
 * }
 * 
 * // This will compile successfully if MyService is a valid data service
 * type CheckValidDataService = Assert<IsDataService<MyService>>;
 * ```
 */

// Test cases demonstrating valid data service patterns
...
// Validates that the example service conforms to data-service pattern
type _ExampleServiceCheck = Assert<IsDataService<_ExampleService>>;
